...
class mag01_mlp():
    ...
    def __init__(self):
        # import model
        filename = "savedModels/MLP_Malaga.h5"
        self.model = keras.models.load_model(filename)

        # define required inputs
        self.parameters = ['tx', 'tn', 'ra', 'es', 'et0']
    ...
    def getStandardDataTest(self):
        ...
        mean_list = [23.85, 12.54, 29.18, 2.34]
        std_list = [41.11, 30.84, 88.34, 0.74]
...
if __name__ == '__main__':
    mlModel = mag01_mlp()
    mlModel.import_dataset("data/MAG01.csv", 'csv')
