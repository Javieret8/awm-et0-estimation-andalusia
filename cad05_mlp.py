...
class cad05_mlp():
    ...
    It uses a SVM model and the following input configuration (being rs the predicted value):
        ['tx', 'tn', 'ra', 'hourmin_ocaso-hourmin_tx', 'et0']

    """
    def __init__(self):
        # import model
        filename = "savedModels/MLP_Conil.h5"
        self.model = keras.models.load_model(filename)

        # define required inputs
        self.parameters = ['tx', 'tn', 'ra', 'hourmin_ocaso-hourmin_tx', 'et0']
    ...
    def getStandardDataTest(self):
        ...
        mean_list = [23.10, 12.08, 29.40, 5.13]
        std_list = [33.31, 29.11, 85.13, 3.67]
...
if __name__ == '__main__':
    mlModel = cad05_mlp()
    mlModel.import_dataset("data/CAD05.csv", 'csv')
